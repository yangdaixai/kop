        ...
        getTopicBroker(topic)
                ...
                .thenAccept(kopAddressFuture -> kopAddressFuture.thenAccept(listeners -> {
                    ...
                    final EndPoint endPoint =
                            (tlsEnabled ? EndPoint.getSslEndPoint(listeners.get(), EndPoint.parseProtocolMap(this.kafkaProtocolMap)) :
                                    EndPoint.getPlainTextEndPoint(listeners.get(),  EndPoint.parseProtocolMap(this.kafkaProtocolMap)));
